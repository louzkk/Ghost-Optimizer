...
This script applies a custom power plan along with optimized profiles for NVIDIA, OOSU10++, and Quad9 DNS, which you can review directly in the code.
...
2. Open `How.To.Install.txt` or `Ghost-Optimizer.bat`   
